...
public class ClientTest extends BaseTest {
    ...
    @FrameworkAnnotation(author = {AuthorType.Jmrd, AuthorType.Jmrd}, category = {CategoryType.REGRESSION})
    ...
    @FrameworkAnnotation(author = {AuthorType.Jmrd}, category = {CategoryType.SANITY, CategoryType.REGRESSION})
